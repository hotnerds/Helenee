...
public class CommentExistsException extends ApplicationException {
    ...
    protected CommentExistsException(String error_code, HttpStatus httpStatus, String message) {
